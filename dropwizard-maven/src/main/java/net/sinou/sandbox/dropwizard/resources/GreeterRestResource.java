...
import net.sinou.sandbox.dropwizard.api.BackendDTO;
...
public class GreeterRestResource {
	...
	public String greeting() {
		...
		System.out.println("Full URL: " + client.target(backendServiceUrl).path("api").path("backend")
				.queryParam("greeting", saying).getUri().toString());
